...
创建调度任务：
任务名称：<input type="text" id="taskType" width="30">
处理Bean:<input type="text" id="dealBean" width="30">
队列ID:<input type="text" id="queueIds" width="30">
...
<br/>
<b>
任务运行期信息：任务名称：</b><input type="text" id="baseTaskType" width="30">

<%if("true".equals(isManager)){%>

<input type="button" value="清除运行期信息" onclick="clearTaskType();" width="30">
<input type="button" value="删除任务" onclick="deleteTaskType();" width="30">

<%}%>
<br/><br/>
<iframe  name="taskDetail" height="70%" width="100%"></iframe>
</body>
</html>
<script>
function openDetail(baseTaskType){
	//window.open("taskTypeInfo.jsp?baseTaskType=" + baseTaskType);	
...
function createTaskType(){
	 ...
	 var url ="taskType="+taskType + "&dealBean="+ dealBean +"&queueIds="+queueIds;
